...
import { LineChart, Activity, Heart, Droplets, Pill, Calendar, Repeat } from 'lucide-react';
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100">Vital Signs</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-4 bg-blue-50 dark:bg-blue-900 rounded-lg">
          <div className="flex items-center">
            ...
            <span className="text-sm font-medium text-gray-600 dark:text-gray-300">Blood Pressure</span>
          </div>
          <ul className="mt-2 text-sm text-gray-600 dark:text-gray-300">
            <li>
              {mockVitalsData.bloodPressure.time}: {mockVitalsData.bloodPressure.systolic}/{mockVitalsData.bloodPressure.diastolic} mmHg
            </li>
          </ul>
        </div>
        ...
        <div className="p-4 bg-yellow-50 dark:bg-yellow-900 rounded-lg">
          <div className="flex items-center">
            ...
            <span className="text-sm font-medium text-gray-600 dark:text-gray-300">Oxygen Levels</span>
          </div>
          <ul className="mt-2 text-sm text-gray-600 dark:text-gray-300">
      ...
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100">Medications</h2>
        <Pill className="h-5 w-5 text-gray-500 dark:text-gray-400" />
      </div>
      <div className="space-y-4">
        {mockVitalsData.medications.map((med, index) => (
          <div key={index} className="p-4 bg-purple-50 dark:bg-purple-900 rounded-lg shadow-sm flex justify-between items-center">
            <div>
              <h3 className="text-md font-medium text-gray-800 dark:text-gray-100">{med.name}</h3>
